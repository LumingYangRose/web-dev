...
let blockScoped = 5;
const constant1 = global + functionScoped - blockScoped;
...
// for (const [index, value] of variableArray1.entries()) {
//     console.log(index + ' : ' + variableArray1[index]);
// }

// variableArray1.forEach((i, x) => console.log(x));
